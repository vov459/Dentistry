...
class ServicesEditView implements ViewInterface{
    ...
    public function render(): void
    {
        ...
        <form action="/db_app/save/service">
            ...
            <div class="input-group mb-3">
                ...
                <input required type="text" name="number" value="<?=$data->getNumber()?>" class="border-dark form-control" placeholder="" aria-label="" aria-describedby="basic-addon1">
            </div>
            <div class="input-group mb-3">
                <div class="input-group-prepend">
